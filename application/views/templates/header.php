                ...
                <div class="nano-content sidebar-nav">
                    <ul class="metisMenu nav flex-column" id="menu">
                       ...
                       <!-- <li class="nav-heading"><span>Main</span></li>-->
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="javascript: void(0);" aria-expanded="true"><i class="fa fa-envelope-o"></i> <span class="toggle-none">Product<span class="fa arrow"></span></span></a>
                            <ul class="nav-second-level nav flex-column sub-menu" aria-expanded="true">
                                <li class="nav-item"><a class="nav-link" href="<?php echo base_url('dashboard/pcategory');?>">Add Category</a></li>
                                <li class="nav-item"><a class="nav-link" href="<?php echo base_url('dashboard/subcategory');?>">Add Sub Category</a></li>
                                <li class="nav-item"><a class="nav-link" href="<?php echo base_url('dashboard/product');?>">Add Product</a></li> 
                            </ul>
                        </li>
